...
export const sourceSchema = z.object({
  ...
  type: optionalText,
  author1_zh: optionalText,
  author1_en: optionalText,
  author2_zh: optionalText,
  author2_en: optionalText,
  author3_zh: optionalText,
  author3_en: optionalText,
  editor_zh: optionalText,
  editor_en: optionalText,
  title_zh: optionalText,
  title_en: optionalText,
  book_zh: optionalText,
  book_en: optionalText,
  language: optionalText,
  year: optionalNumber,
  publication_zh: optionalText,
  publication_en: optionalText,
  place_zh: optionalText,
  place_en: optionalText,
  volume: optionalText,
  date: optionalText,
  page: optionalText,
