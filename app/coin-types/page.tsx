...
// read once here, server-side, rather than fetched client-side, same as
// every other prop TypologyViewer's siblings on this page receive.
function loadTypologyManifest(): TypologyViewerManifest {
