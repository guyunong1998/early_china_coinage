...
export const metadata = {
  title: 'Coin Type Heatmap | Early Chinese Coin Finds',
  description: 'Interactive map showing how coin types are distributed across find sites.',
}

export default async function CoinTypesPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      ...
      <Pagination
        ...
        buildHref={(p) => `/coin-types${p === 1 ? '' : `?page=${p}`}`}
      />
    </div>
  )
}
